...
#include "W_Reticle_AssaultRifle_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_Reticle_AssaultRifle.W_Reticle_AssaultRifle_C
// 0x0058 (0x02D0 - 0x0278)
class UW_Reticle_AssaultRifle_C : public UReticleWidget
{
public:
	...
	class UImage*                                      Overheating;                                              // 0x0298(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	class UCanvasPanel*                                ReticleRoot;                                              // 0x02A0(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_Reticle_AssaultRifle.W_Reticle_AssaultRifle_C"));
		return ptr;
	}


	void OnPawnAcquired_12B87B46431E2FED1F2ACBA6E5961110(class APawn* Pawn);
	void Construct();
	void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
	void Calculate_Overheat();
	void ExecuteUbergraph_W_Reticle_AssaultRifle(int EntryPoint);
};
