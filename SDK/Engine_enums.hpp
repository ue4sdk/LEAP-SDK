...
// Enum Engine.EVoteResult
enum class EVoteResult : uint8_t
{
	EVoteResult__Success           = 0,
	EVoteResult__Failed            = 1,
	EVoteResult__None              = 2,
	EVoteResult__EVoteResult_MAX   = 3
};
...
// Enum Engine.EVoteInstanceTrigger
enum class EVoteInstanceTrigger : uint8_t
{
	EVoteInstanceTrigger__Disabled = 0,
	EVoteInstanceTrigger__AnyTime  = 1,
	EVoteInstanceTrigger__MatchEnd = 2,
	EVoteInstanceTrigger__EVoteInstanceTrigger_MAX = 3
};
