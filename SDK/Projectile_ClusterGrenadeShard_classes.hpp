...
#include "Projectile_ClusterGrenadeShard_structs.hpp"
...
// BlueprintGeneratedClass Projectile_ClusterGrenadeShard.Projectile_ClusterGrenadeShard_C
// 0x0020 (0x04F0 - 0x04D0)
class AProjectile_ClusterGrenadeShard_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Projectile_ClusterGrenadeShard.Projectile_ClusterGrenadeShard_C"));
		return ptr;
	}
