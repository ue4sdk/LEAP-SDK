...
#include "ClientProjectile_BuggyGrenade_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_BuggyGrenade.ClientProjectile_BuggyGrenade_C
// 0x0018 (0x04E8 - 0x04D0)
class AClientProjectile_BuggyGrenade_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_BuggyGrenade.ClientProjectile_BuggyGrenade_C"));
		return ptr;
	}
