...
#include "ClientProjectile_SMG_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_SMG.ClientProjectile_SMG_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_SMG_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_SMG.ClientProjectile_SMG_C"));
		return ptr;
	}
