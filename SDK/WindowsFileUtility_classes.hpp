...
#include "WindowsFileUtility_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class WindowsFileUtility.WFUFileListInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class WindowsFileUtility.WFUFileListLambdaDelegate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class WindowsFileUtility.WFUFolderWatchInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class WindowsFileUtility.WFUFolderWatchLambdaDelegate"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class WindowsFileUtility.WindowsFileUtilityFunctionLibrary"));
		return ptr;
	}
