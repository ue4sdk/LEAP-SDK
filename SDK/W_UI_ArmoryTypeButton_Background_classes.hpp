...
#include "W_UI_ArmoryTypeButton_Background_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_UI_ArmoryTypeButton_Background.W_UI_ArmoryTypeButton_Background_C
// 0x0019 (0x0279 - 0x0260)
class UW_UI_ArmoryTypeButton_Background_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_UI_ArmoryTypeButton_Background.W_UI_ArmoryTypeButton_Background_C"));
		return ptr;
	}


	void SetActive();
	void ExecuteUbergraph_W_UI_ArmoryTypeButton_Background(int EntryPoint);
};
