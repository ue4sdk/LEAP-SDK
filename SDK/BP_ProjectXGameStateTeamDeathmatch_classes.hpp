...
#include "BP_ProjectXGameStateTeamDeathmatch_structs.hpp"
...
// BlueprintGeneratedClass BP_ProjectXGameStateTeamDeathmatch.BP_ProjectXGameStateTeamDeathmatch_C
// 0x0038 (0x0600 - 0x05C8)
class ABP_ProjectXGameStateTeamDeathmatch_C : public AProjectXGameState
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ProjectXGameStateTeamDeathmatch.BP_ProjectXGameStateTeamDeathmatch_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ProjectXGameStateTeamDeathmatch(int EntryPoint);
};
