...
#include "W_Shotgun_AmmoCounter_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_Shotgun_AmmoCounter.W_Shotgun_AmmoCounter_C
// 0x0030 (0x0290 - 0x0260)
class UW_Shotgun_AmmoCounter_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_Shotgun_AmmoCounter.W_Shotgun_AmmoCounter_C"));
		return ptr;
	}


	void OnPawnAcquired_EA7D0B3347E9CD518175C48FED9B4397(class APawn* Pawn);
	void AmmoChanged(int Amount);
	void Construct();
	void ExecuteUbergraph_W_Shotgun_AmmoCounter(int EntryPoint);
};
