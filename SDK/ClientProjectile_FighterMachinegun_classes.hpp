...
#include "ClientProjectile_FighterMachinegun_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_FighterMachinegun.ClientProjectile_FighterMachinegun_C
// 0x0018 (0x04E8 - 0x04D0)
class AClientProjectile_FighterMachinegun_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_FighterMachinegun.ClientProjectile_FighterMachinegun_C"));
		return ptr;
	}
