...
#include "ClientProjectile_Rocket_Ultimate_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Rocket_Ultimate.ClientProjectile_Rocket_Ultimate_C
// 0x0020 (0x04F0 - 0x04D0)
class AClientProjectile_Rocket_Ultimate_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Rocket_Ultimate.ClientProjectile_Rocket_Ultimate_C"));
		return ptr;
	}
