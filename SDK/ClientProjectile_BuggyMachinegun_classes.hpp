...
#include "ClientProjectile_BuggyMachinegun_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_BuggyMachinegun.ClientProjectile_BuggyMachinegun_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_BuggyMachinegun_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_BuggyMachinegun.ClientProjectile_BuggyMachinegun_C"));
		return ptr;
	}
