...
#include "ClientProjectile_Machinegun_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Machinegun.ClientProjectile_Machinegun_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_Machinegun_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Machinegun.ClientProjectile_Machinegun_C"));
		return ptr;
	}
