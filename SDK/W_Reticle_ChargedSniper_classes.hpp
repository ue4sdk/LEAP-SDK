...
#include "W_Reticle_ChargedSniper_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_Reticle_ChargedSniper.W_Reticle_ChargedSniper_C
// 0x0050 (0x02C8 - 0x0278)
class UW_Reticle_ChargedSniper_C : public UReticleWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_Reticle_ChargedSniper.W_Reticle_ChargedSniper_C"));
		return ptr;
	}


	void OnPawnAcquired_1A632A94450B86C87767E793206DACA4(class APawn* Pawn);
	void Construct();
	void OnWeaponFire_Event_1(unsigned char Mode);
	void Recoil(float Value);
	void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
	void SetChargeProgress(float Value);
	void ExecuteUbergraph_W_Reticle_ChargedSniper(int EntryPoint);
};
