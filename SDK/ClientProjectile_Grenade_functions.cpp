...
#include "ClientProjectile_Grenade_classes.hpp"
...
// Function ClientProjectile_Grenade.ClientProjectile_Grenade_C.ReceiveHit
...
void AClientProjectile_Grenade_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ClientProjectile_Grenade.ClientProjectile_Grenade_C.ReceiveHit"));
...
// Function ClientProjectile_Grenade.ClientProjectile_Grenade_C.ExecuteUbergraph_ClientProjectile_Grenade
// (FUNC_Final, FUNC_HasDefaults)
// Parameters:
// int                            EntryPoint                     (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

void AClientProjectile_Grenade_C::ExecuteUbergraph_ClientProjectile_Grenade(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ClientProjectile_Grenade.ClientProjectile_Grenade_C.ExecuteUbergraph_ClientProjectile_Grenade"));
