...
#include "W_VehicleScreen_classes.hpp"
...
// Function W_VehicleScreen.W_VehicleScreen_C.ValidCosmeticSlot
...
void UW_VehicleScreen_C::ValidCosmeticSlot(EEquipSlot RowName, bool* FoundCosmetics)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.ValidCosmeticSlot"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.InitWeapon
...
void UW_VehicleScreen_C::InitWeapon(class UClass* /*UWeaponInstance*/ Weapon, class UClass* /*AProjectXCharacter*/ Player_Class, EEquipSlot EquipSlot)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.InitWeapon"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.BndEvt__W_CosmeticItemListGrid_K2Node_ComponentBoundEvent_2_ItemClicked__DelegateSignature
// (FUNC_BlueprintEvent)
// Parameters:
...
void UW_VehicleScreen_C::BndEvt__W_CosmeticItemListGrid_K2Node_ComponentBoundEvent_2_ItemClicked__DelegateSignature(const struct FString& ItemId, ECosmeticType Type, const struct FString& WeaponID, unsigned char Slot, class UW_ArmoryIcon_C* NewParam)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.BndEvt__W_CosmeticItemListGrid_K2Node_ComponentBoundEvent_2_ItemClicked__DelegateSignature"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.EquipCosmeticItem
// (FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
void UW_VehicleScreen_C::EquipCosmeticItem(class UClass* /*AProjectXCharacter*/ CharacterClass, ECosmeticType Type, const struct FString& CosmeticID, const struct FString& WeaponName, class UW_ArmoryIcon_C* Widget)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.EquipCosmeticItem"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.BndEvt__btn_Back_K2Node_ComponentBoundEvent_1_Clicked__DelegateSignature
// (FUNC_BlueprintEvent)
// Parameters:
...
void UW_VehicleScreen_C::BndEvt__btn_Back_K2Node_ComponentBoundEvent_1_Clicked__DelegateSignature(const struct FString& ID, const struct FString& Name, ECosmeticType Type, class UClass* /*UUserWidget*/ Widget)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.BndEvt__btn_Back_K2Node_ComponentBoundEvent_1_Clicked__DelegateSignature"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.BndEvt__W_CosmeticItemListGrid_K2Node_ComponentBoundEvent_0_ItemHovered__DelegateSignature
// (FUNC_BlueprintEvent)
// Parameters:
...
void UW_VehicleScreen_C::BndEvt__W_CosmeticItemListGrid_K2Node_ComponentBoundEvent_0_ItemHovered__DelegateSignature(bool bHovered, const struct FString& ItemId, ECosmeticType Type, const struct FString& WeaponID, unsigned char Slot, class UW_ArmoryIcon_C* Widget)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.BndEvt__W_CosmeticItemListGrid_K2Node_ComponentBoundEvent_0_ItemHovered__DelegateSignature"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.ExecuteUbergraph_W_VehicleScreen
// (FUNC_Final, FUNC_HasDefaults)
// Parameters:
// int                            EntryPoint                     (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

void UW_VehicleScreen_C::ExecuteUbergraph_W_VehicleScreen(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.ExecuteUbergraph_W_VehicleScreen"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.ItemSelected__DelegateSignature
...
void UW_VehicleScreen_C::ItemSelected__DelegateSignature(bool Selected, ECosmeticType Type, const struct FString& WeaponID, unsigned char Slot, const struct FString& ShortCode, class UClass* /*AProjectXCharacter*/ NewParam)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.ItemSelected__DelegateSignature"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.TypeSelected__DelegateSignature
// (FUNC_Public, FUNC_Delegate, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
void UW_VehicleScreen_C::TypeSelected__DelegateSignature(ECosmeticType CosmeticType)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.TypeSelected__DelegateSignature"));
...
// Function W_VehicleScreen.W_VehicleScreen_C.EquipButtonPressed__DelegateSignature
// (FUNC_Public, FUNC_Delegate, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
void UW_VehicleScreen_C::EquipButtonPressed__DelegateSignature(bool NewParam)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function W_VehicleScreen.W_VehicleScreen_C.EquipButtonPressed__DelegateSignature"));
