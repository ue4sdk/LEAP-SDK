...
#include "ClientProjectile_Flak_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Flak.ClientProjectile_Flak_C
// 0x0018 (0x04E8 - 0x04D0)
class AClientProjectile_Flak_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Flak.ClientProjectile_Flak_C"));
		return ptr;
	}
