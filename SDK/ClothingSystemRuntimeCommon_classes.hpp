...
public:
	...
	struct FClothPhysicalMeshData                      ClothPhysicalMeshData;                                    // 0x0030(0x0108) (CPF_NativeAccessSpecifierPublic)
	struct FClothCollisionData                         CollisionData;                                            // 0x0138(0x0040) (CPF_NativeAccessSpecifierPublic)
