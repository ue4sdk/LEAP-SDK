...
#include "ClientProjectile_Pistol_Ultimate_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Pistol_Ultimate.ClientProjectile_Pistol_Ultimate_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_Pistol_Ultimate_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Pistol_Ultimate.ClientProjectile_Pistol_Ultimate_C"));
		return ptr;
	}
