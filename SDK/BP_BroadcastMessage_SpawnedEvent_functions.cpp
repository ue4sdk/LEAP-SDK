...
#include "BP_BroadcastMessage_SpawnedEvent_classes.hpp"
...
// Function BP_BroadcastMessage_SpawnedEvent.BP_BroadcastMessage_SpawnedEvent_C.K2_ReceiveMessage
...
void UBP_BroadcastMessage_SpawnedEvent_C::K2_ReceiveMessage(class AProjectXPlayerController* PlayerController, int Data, class APlayerState* PlayerStateA, class APlayerState* PlayerStateB, class UObject* Object)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BroadcastMessage_SpawnedEvent.BP_BroadcastMessage_SpawnedEvent_C.K2_ReceiveMessage"));
