...
#include "W_SMG_AmmoCounter_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_SMG_AmmoCounter.W_SMG_AmmoCounter_C
// 0x0018 (0x0278 - 0x0260)
class UW_SMG_AmmoCounter_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_SMG_AmmoCounter.W_SMG_AmmoCounter_C"));
		return ptr;
	}


	void OnPawnAcquired_3B17C4214E25CC3AB5F035A0337C7342(class APawn* Pawn);
	void AmmoChanged(int Amount);
	void Construct();
	void ExecuteUbergraph_W_SMG_AmmoCounter(int EntryPoint);
};
