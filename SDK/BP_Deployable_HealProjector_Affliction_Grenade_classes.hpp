...
#include "BP_Deployable_HealProjector_Affliction_Grenade_structs.hpp"
...
// BlueprintGeneratedClass BP_Deployable_HealProjector_Affliction_Grenade.BP_Deployable_HealProjector_Affliction_Grenade_C
// 0x0018 (0x0280 - 0x0268)
class UBP_Deployable_HealProjector_Affliction_Grenade_C : public UAfflictionInstanceHealProjector
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Deployable_HealProjector_Affliction_Grenade.BP_Deployable_HealProjector_Affliction_Grenade_C"));
		return ptr;
	}
	...
	void K2_Start();
	void K2_End();
	void ExecuteUbergraph_BP_Deployable_HealProjector_Affliction_Grenade(int EntryPoint);
};
