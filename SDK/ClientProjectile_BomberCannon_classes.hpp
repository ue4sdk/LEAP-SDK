...
#include "ClientProjectile_BomberCannon_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_BomberCannon.ClientProjectile_BomberCannon_C
// 0x0020 (0x04F0 - 0x04D0)
class AClientProjectile_BomberCannon_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_BomberCannon.ClientProjectile_BomberCannon_C"));
		return ptr;
	}
