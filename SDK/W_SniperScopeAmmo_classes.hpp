...
#include "W_SniperScopeAmmo_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_SniperScopeAmmo.W_SniperScopeAmmo_C
// 0x0018 (0x0278 - 0x0260)
class UW_SniperScopeAmmo_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_SniperScopeAmmo.W_SniperScopeAmmo_C"));
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_W_SniperScopeAmmo(int EntryPoint);
};
