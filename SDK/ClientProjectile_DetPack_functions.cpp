...
#include "ClientProjectile_DetPack_classes.hpp"
...
// Function ClientProjectile_DetPack.ClientProjectile_DetPack_C.ReceiveBeginPlay
// (FUNC_Event, FUNC_Protected, FUNC_BlueprintEvent)

void AClientProjectile_DetPack_C::ReceiveBeginPlay()
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ClientProjectile_DetPack.ClientProjectile_DetPack_C.ReceiveBeginPlay"));
...
// Function ClientProjectile_DetPack.ClientProjectile_DetPack_C.ReceiveHit
...
void AClientProjectile_DetPack_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ClientProjectile_DetPack.ClientProjectile_DetPack_C.ReceiveHit"));
...
// Function ClientProjectile_DetPack.ClientProjectile_DetPack_C.ExecuteUbergraph_ClientProjectile_DetPack
// (FUNC_Final, FUNC_HasDefaults)
// Parameters:
// int                            EntryPoint                     (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

void AClientProjectile_DetPack_C::ExecuteUbergraph_ClientProjectile_DetPack(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function ClientProjectile_DetPack.ClientProjectile_DetPack_C.ExecuteUbergraph_ClientProjectile_DetPack"));
