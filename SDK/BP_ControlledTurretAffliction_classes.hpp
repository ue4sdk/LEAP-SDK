...
#include "BP_ControlledTurretAffliction_structs.hpp"
...
// BlueprintGeneratedClass BP_ControlledTurretAffliction.BP_ControlledTurretAffliction_C
// 0x0058 (0x0250 - 0x01F8)
class UBP_ControlledTurretAffliction_C : public UAfflictionInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ControlledTurretAffliction.BP_ControlledTurretAffliction_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ControlledTurretAffliction(int EntryPoint);
};
