...
#include "ClientProjectile_AssaultRifle_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_AssaultRifle.ClientProjectile_AssaultRifle_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_AssaultRifle_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_AssaultRifle.ClientProjectile_AssaultRifle_C"));
		return ptr;
	}
