...
#include "BP_BroadcastMessage_AWO_ShieldGeneratorDestroyed_classes.hpp"
...
// Function BP_BroadcastMessage_AWO_ShieldGeneratorDestroyed.BP_BroadcastMessage_AWO_ShieldGeneratorDestroyed_C.K2_ReceiveMessage
...
void UBP_BroadcastMessage_AWO_ShieldGeneratorDestroyed_C::K2_ReceiveMessage(class AProjectXPlayerController* PlayerController, int Data, class APlayerState* PlayerStateA, class APlayerState* PlayerStateB, class UObject* Object)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BroadcastMessage_AWO_ShieldGeneratorDestroyed.BP_BroadcastMessage_AWO_ShieldGeneratorDestroyed_C.K2_ReceiveMessage"));
