...
#include "W_ShootingRangeUI_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_ShootingRangeUI.W_ShootingRangeUI_C
// 0x00A0 (0x0318 - 0x0278)
class UW_ShootingRangeUI_C : public UHUDBasicUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_ShootingRangeUI.W_ShootingRangeUI_C"));
		return ptr;
	}
	...
	void OnGameStateAcquired_F5DF96CB4B310BF8E4DEE28A3A43C909(class AGameState* GameState);
	void Construct();
	void PreConstruct(bool IsDesignTime);
	void LowOnTickets(class AProjectXPlayerController* PlayerController, int Data);
	void ExecuteUbergraph_W_ShootingRangeUI(int EntryPoint);
};
