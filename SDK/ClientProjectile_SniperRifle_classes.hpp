...
#include "ClientProjectile_SniperRifle_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_SniperRifle.ClientProjectile_SniperRifle_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_SniperRifle_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_SniperRifle.ClientProjectile_SniperRifle_C"));
		return ptr;
	}
