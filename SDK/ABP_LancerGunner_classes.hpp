...
#include "ABP_LancerGunner_structs.hpp"
...
// AnimBlueprintGeneratedClass ABP_LancerGunner.ABP_LancerGunner_C
// 0x02C8 (0x0588 - 0x02C0)
class UABP_LancerGunner_C : public UAnimInstance
{
public:
	...
	struct FRotator                                    TurretAimRotation;                                        // 0x0560(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor)
	float                                              DeltaSeconds;                                             // 0x056C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_LancerGunner.ABP_LancerGunner_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_ABP_LancerGunner(int EntryPoint);
};
