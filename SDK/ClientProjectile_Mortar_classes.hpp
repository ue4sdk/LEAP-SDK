...
#include "ClientProjectile_Mortar_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Mortar.ClientProjectile_Mortar_C
// 0x0018 (0x04E8 - 0x04D0)
class AClientProjectile_Mortar_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Mortar.ClientProjectile_Mortar_C"));
		return ptr;
	}
