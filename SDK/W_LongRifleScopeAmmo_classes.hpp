...
#include "W_LongRifleScopeAmmo_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_LongRifleScopeAmmo.W_LongRifleScopeAmmo_C
// 0x0018 (0x0278 - 0x0260)
class UW_LongRifleScopeAmmo_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_LongRifleScopeAmmo.W_LongRifleScopeAmmo_C"));
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_W_LongRifleScopeAmmo(int EntryPoint);
};
