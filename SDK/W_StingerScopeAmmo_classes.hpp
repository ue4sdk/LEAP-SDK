...
#include "W_StingerScopeAmmo_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_StingerScopeAmmo.W_StingerScopeAmmo_C
// 0x0018 (0x0278 - 0x0260)
class UW_StingerScopeAmmo_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_StingerScopeAmmo.W_StingerScopeAmmo_C"));
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_W_StingerScopeAmmo(int EntryPoint);
};
