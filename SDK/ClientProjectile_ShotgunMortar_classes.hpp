...
#include "ClientProjectile_ShotgunMortar_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_ShotgunMortar.ClientProjectile_ShotgunMortar_C
// 0x0018 (0x04E8 - 0x04D0)
class AClientProjectile_ShotgunMortar_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_ShotgunMortar.ClientProjectile_ShotgunMortar_C"));
		return ptr;
	}
