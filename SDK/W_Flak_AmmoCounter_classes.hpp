...
#include "W_Flak_AmmoCounter_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_Flak_AmmoCounter.W_Flak_AmmoCounter_C
// 0x0030 (0x0290 - 0x0260)
class UW_Flak_AmmoCounter_C : public UUserWidget
{
public:
	...
	class UVerticalBox*                                Dots;                                                     // 0x0278(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_Flak_AmmoCounter.W_Flak_AmmoCounter_C"));
		return ptr;
	}


	void OnPawnAcquired_595EDEDE43B8F6F73F8F7B8236C43629(class APawn* Pawn);
	void AmmoChanged(int Amount);
	void Construct();
	void ExecuteUbergraph_W_Flak_AmmoCounter(int EntryPoint);
};
