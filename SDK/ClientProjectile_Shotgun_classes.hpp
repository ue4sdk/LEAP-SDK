...
#include "ClientProjectile_Shotgun_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Shotgun.ClientProjectile_Shotgun_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_Shotgun_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Shotgun.ClientProjectile_Shotgun_C"));
		return ptr;
	}
