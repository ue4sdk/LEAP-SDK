...
void UUserWidget::StopAllAnimations(bool bRestoreState)
{
...
// Function UMG.UserWidget.PoolDestruct
// (FUNC_BlueprintCosmetic, FUNC_Event, FUNC_Public, FUNC_BlueprintEvent)

void UUserWidget::PoolDestruct()
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.UserWidget.PoolDestruct"));
...
// Function UMG.UserWidget.PoolConstruct
// (FUNC_BlueprintCosmetic, FUNC_Event, FUNC_Public, FUNC_BlueprintEvent)

void UUserWidget::PoolConstruct()
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.UserWidget.PoolConstruct"));
...
// Function UMG.Button.SetFocusable
// (FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// bool                           bFocusable                     (CPF_ConstParm, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UButton::SetFocusable(bool bFocusable)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.Button.SetFocusable"));
