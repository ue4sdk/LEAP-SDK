...
#include "ClientProjectile_GunTurret_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_GunTurret.ClientProjectile_GunTurret_C
// 0x0018 (0x04E8 - 0x04D0)
class AClientProjectile_GunTurret_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_GunTurret.ClientProjectile_GunTurret_C"));
		return ptr;
	}
