...
#include "W_WeaponScreen_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_WeaponScreen.W_WeaponScreen_C
// 0x0098 (0x02F8 - 0x0260)
class UW_WeaponScreen_C : public UUserWidget
{
public:
	...
	class UW_CosmeticTypesButtonList_C*                W_CosmeticTypesButtonList;                                // 0x0280(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	class UClass* /*UWeaponInstance*/                  Weapon;                                                   // 0x0288(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	struct FString                                     CosmeticTypeName;                                         // 0x0290(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_HasGetValueTypeHash)
	class UDataTable*                                  ItemTable;                                                // 0x02A0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	class UClass* /*AProjectXCharacter*/               Player_Class;                                             // 0x02A8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	struct FMulticastScriptDelegate                    EquipButtonPressed;                                       // 0x02B8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
	struct FString                                     NewVar_1;                                                 // 0x02C8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_HasGetValueTypeHash)
	struct FMulticastScriptDelegate                    TypeSelected;                                             // 0x02D8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_WeaponScreen.W_WeaponScreen_C"));
		return ptr;
	}
	...
	void BndEvt__W_CosmeticTypesButtonList_K2Node_ComponentBoundEvent_3_OnTypeButtonPressed__DelegateSignature(const struct FString& CosmeticType);
	...
	void ExecuteUbergraph_W_WeaponScreen(int EntryPoint);
