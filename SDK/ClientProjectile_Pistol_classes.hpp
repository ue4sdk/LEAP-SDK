...
#include "ClientProjectile_Pistol_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Pistol.ClientProjectile_Pistol_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_Pistol_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Pistol.ClientProjectile_Pistol_C"));
		return ptr;
	}
