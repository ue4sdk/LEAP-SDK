...
#include "ClientProjectile_Knife_Ultimate_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Knife_Ultimate.ClientProjectile_Knife_Ultimate_C
// 0x0020 (0x0430 - 0x0410)
class AClientProjectile_Knife_Ultimate_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Knife_Ultimate.ClientProjectile_Knife_Ultimate_C"));
		return ptr;
	}


	void ReceiveTick(float DeltaSeconds);
	void ExecuteUbergraph_ClientProjectile_Knife_Ultimate(int EntryPoint);
};
