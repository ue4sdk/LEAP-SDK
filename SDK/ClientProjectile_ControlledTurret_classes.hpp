...
#include "ClientProjectile_ControlledTurret_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_ControlledTurret.ClientProjectile_ControlledTurret_C
// 0x0018 (0x04E8 - 0x04D0)
class AClientProjectile_ControlledTurret_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_ControlledTurret.ClientProjectile_ControlledTurret_C"));
		return ptr;
	}
