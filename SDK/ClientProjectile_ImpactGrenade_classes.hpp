...
#include "ClientProjectile_ImpactGrenade_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_ImpactGrenade.ClientProjectile_ImpactGrenade_C
// 0x0020 (0x04F0 - 0x04D0)
class AClientProjectile_ImpactGrenade_C : public AProjectileExplosive
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_ImpactGrenade.ClientProjectile_ImpactGrenade_C"));
		return ptr;
	}
