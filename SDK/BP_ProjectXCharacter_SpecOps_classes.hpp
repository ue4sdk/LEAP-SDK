...
#include "BP_ProjectXCharacter_SpecOps_structs.hpp"
...
// BlueprintGeneratedClass BP_ProjectXCharacter_SpecOps.BP_ProjectXCharacter_SpecOps_C
// 0x0014 (0x0F20 - 0x0F0C)
class ABP_ProjectXCharacter_SpecOps_C : public ABP_ProjectXCharacter_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ProjectXCharacter_SpecOps.BP_ProjectXCharacter_SpecOps_C"));
		return ptr;
	}
