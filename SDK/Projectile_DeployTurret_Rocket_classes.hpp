...
#include "Projectile_DeployTurret_Rocket_structs.hpp"
...
// BlueprintGeneratedClass Projectile_DeployTurret_Rocket.Projectile_DeployTurret_Rocket_C
// 0x0020 (0x04F0 - 0x04D0)
class AProjectile_DeployTurret_Rocket_C : public AProjectileExplosive
{
public:
	...
	class UStaticMeshComponent*                        bullet;                                                   // 0x04D8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Projectile_DeployTurret_Rocket.Projectile_DeployTurret_Rocket_C"));
		return ptr;
	}
