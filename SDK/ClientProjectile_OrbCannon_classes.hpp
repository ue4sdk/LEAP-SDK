...
#include "ClientProjectile_OrbCannon_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_OrbCannon.ClientProjectile_OrbCannon_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_OrbCannon_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_OrbCannon.ClientProjectile_OrbCannon_C"));
		return ptr;
	}
