...
#include "BP_DeployableMarker_SpawnPoint_structs.hpp"
...
// BlueprintGeneratedClass BP_DeployableMarker_SpawnPoint.BP_DeployableMarker_SpawnPoint_C
// 0x0020 (0x0268 - 0x0248)
class ABP_DeployableMarker_SpawnPoint_C : public ADeployableMarker
{
public:
	...
	class UStaticMeshComponent*                        StaticMesh;                                               // 0x0250(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_DeployableMarker_SpawnPoint.BP_DeployableMarker_SpawnPoint_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_DeployableMarker_SpawnPoint(int EntryPoint);
};
