...
#include "W_CircularTimer_structs.hpp"
...
// WidgetBlueprintGeneratedClass W_CircularTimer.W_CircularTimer_C
// 0x0025 (0x0285 - 0x0260)
class UW_CircularTimer_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass W_CircularTimer.W_CircularTimer_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_W_CircularTimer(int EntryPoint);
};
