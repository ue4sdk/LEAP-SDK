...
#include "ClientProjectile_LongRifle_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_LongRifle.ClientProjectile_LongRifle_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_LongRifle_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_LongRifle.ClientProjectile_LongRifle_C"));
		return ptr;
	}
