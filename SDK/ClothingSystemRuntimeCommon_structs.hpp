...
{
	struct FClothPhysicalMeshData                      PhysicalMeshData;                                         // 0x0000(0x0108) (CPF_Edit, CPF_NativeAccessSpecifierPublic)
	struct FClothCollisionData                         CollisionData;                                            // 0x0108(0x0040) (CPF_Edit, CPF_NativeAccessSpecifierPublic)
	bool                                               bUseMultipleInfluences;                                   // 0x0148(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0149(0x0003) MISSED OFFSET
	float                                              SkinningKernelRadius;                                     // 0x014C(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
