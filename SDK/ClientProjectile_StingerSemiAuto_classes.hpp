...
#include "ClientProjectile_StingerSemiAuto_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_StingerSemiAuto.ClientProjectile_StingerSemiAuto_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_StingerSemiAuto_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_StingerSemiAuto.ClientProjectile_StingerSemiAuto_C"));
		return ptr;
	}
