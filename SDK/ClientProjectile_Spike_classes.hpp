...
#include "ClientProjectile_Spike_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_Spike.ClientProjectile_Spike_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_Spike_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_Spike.ClientProjectile_Spike_C"));
		return ptr;
	}
