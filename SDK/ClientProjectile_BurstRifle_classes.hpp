...
#include "ClientProjectile_BurstRifle_structs.hpp"
...
// BlueprintGeneratedClass ClientProjectile_BurstRifle.ClientProjectile_BurstRifle_C
// 0x0018 (0x0428 - 0x0410)
class AClientProjectile_BurstRifle_C : public AProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ClientProjectile_BurstRifle.ClientProjectile_BurstRifle_C"));
		return ptr;
	}
